    ...
    <main className="items-center justify-center bg-[url('/images/background.avif')] bg-fixed bg-cover">
        ...
        <div className="w-full">
            ...
            <h1 className="text-center md:text-7xl max-sm:text-2xl w-1/2 max-lg:w-full font-serif">Aventura Matemática: Sumando con Diversión</h1>
                ...
                <video className="rounded-lg mx-auto shadow-lg" src="/videos/restasv.mp4" height={720} width={480} controls></video>
            ...
            <div className="bg-slate-100 text-xl m-8 rounded-xl shadow-lg shadow-black">
                ...
                <div className="grid grid-flow-col max-md:grid-flow-row items-center justify-between mx-auto bg-red-600 w-3/4 rounded-xl shadow-lg">
                    <div className="grid grid-flow-col w-fit m-1 justify-evenly">
                    ...
                    <div className="grid grid-flow-col w-fit mx-auto justify-evenly">
                ...
                <div className="flex flex-col">
                    <div className="flex grid-cols-3 items-center justify-evenly mx-auto bg-red-600 w-3/4 h-2/3 rounded-xl">
