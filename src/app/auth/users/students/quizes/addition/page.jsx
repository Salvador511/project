...
const App = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center w-full">
      ...
      <a className="items-end justify-end" href="/auth/users/students/courses/sumas">
            <button className="bg-rose-500 font-medium text-center rounded-lg shadow-lg items-center justify-center w-full py-2 px-4 hover:shadow-inner hover:shadow-black hover:bg-rose-700 hover:text-gray-900 text-white transition-all duration-500 mx-auto my-4">
                Regresar al curso
            </button>
        </a>
      <a className="items-end justify-end" href="/auth/users/students/quizes/addition/exam">
            <button className="bg-rose-500 font-medium text-center rounded-lg shadow-lg items-center justify-center w-full py-2 px-4 hover:shadow-inner hover:shadow-black hover:bg-rose-700 hover:text-gray-900 text-white transition-all duration-500 mx-auto my-4">
                Examen
            </button>
        </a>
