...
const page = () => {
  ...
  <div className="container overflow-x-hidden items-center px-10  ml-5 justify-center my-6">
  ...
  <div>
    {!showResult ? (
      <div className="quiz-container list-none bg-purple-200 p-4 mx-3 rounded shadow-2xl shadow-black">
        ...
        {checked ? (
          <button
            ...
            className="btn text-white py-4 px-2 w-full mt-5 mb-5 rounded cursor-pointer animate-pulse transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-500"
          >
      ...
      <div className="quiz-container text-xl py-9 bg-purple-200 shadow-lg shadow-black mx-8 rounded  flex flex-col items-center justify-center">
