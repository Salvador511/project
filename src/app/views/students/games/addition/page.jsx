  ...
  render() {
    ...
    return (
      ...
      <div className="mx-auto text-center">
        <h1 className="text-3xl font-semibold mb-1">Sum Game</h1>
        ...
        <div className="container flex flex-col space-between ">
          <p className="py-6">{resultMessage}</p>
          <button onClick={this.reloadGame} className="bg-blue-500 text-white p-6 rounded">
            Reload
          </button>
        </div>
      ) : (
